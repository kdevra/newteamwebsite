...
<section class="career-banner-cover open-pos-cover-bg valigncenter">
  <div class="container">
    ...
    <div class="container">
      <div class="row">
        <ul class="clearfix valigncenter" style="flex-wrap: wrap;">
          <li><a href="career-work.html"><img src="images/work.png" alt="work icon"> Work</a></li>
          <li><a href="culture.html"><img src="images/cup-icon.png" alt="cup icon"> Culture</a></li>
          <li><a href="career-team.html"><img src="images/team.png" alt="team icon"> Team</a></li>
          <li><a href="open-positions.html"><img src="images/open-positions.png" alt="open positions icon"> Open Positions</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="job-dec cmn-padd cmn-box">
  <div class="container">
    <div class="row clearfix">
     
      <div class="col-md-9 col-xs-12">
      <div class="job-side-left-sec">
       ...
       <div class="det-top-bx">
        <h2 class="cmn-hdr">
            ...
            <span class="line-text">Product Manager</span>
          </h2>
          <h3>Job Description</h3>
          <p>Sales & Business development, evaluating market for new business opportunities, key account management, handling of corporate tie-ups, maintaining relationship with existing clients, implement defined marketing strategies, to achieve targeted sales.<br><br>

The ideal candidate should be MBA Graduate or any graduate, Identifying market for Company's Products Generating new business, selling of Infrastructure solutions/ Product,<br><br>

We offer our customers an entire range of products/ Infrastructure solutions · Data Center Solutions · Business Computing services · Information Security and Availability Services · Server Solutions · Storage Solutions · Networking Solutions · Power Solution and network security Solutions · Software Services & Compliance · Conference Room Solutions & Surveillance · Cloud Computing Solutions . Major job responsibilities will include: 1. Handling corporate tie-ups. 2. Maintaining relations with clients, etc</p><br>
     <h3>Job Location</h3>
     <p>New Delhi</p><br>
     <h3>Qualification</h3>
     <p>You have</p>
     <ul>
		<li>- 1 – 2 years experience in Sales, Account Management or related field</li>
		<li>- Spanish and/or French language skills a plus</li>
		<li>- An understanding of Square’s features and products</li>
		<li>- Strong interest in business operations and strategy</li>
		<li>- Comfortable with cold calling</li>
		<li>- Passion and knowledge about how new technologies can help better serve small and medium size 				  businesses</li>
		<li>- Strong organizational, analytical, written, and verbal communication skills</li>
		<li>- Entrepreneurial spirit</li>
		<li>- Experience with Salesforce and Desk a plus</li>
     </ul>
     </div>
      </div>
      <div class="form">
          ...
          <form  id="contact-form" name="contact" method="post" class="contact-form">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <input type="email" class="form-control" name="email" autocomplete="off" id="email" placeholder="Email Address">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <input type="text" class="form-control" name="phoneNumber" autocomplete="off" id="phoneNumber" placeholder="Phone">
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <input type="text" class="form-control" name="LinkedinProfile" autocomplete="off" id="li-profile" placeholder="Linkedin Profile">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <input type="text" class="form-control" name="source" autocomplete="off" id="source" placeholder="How did you hear about this job?">
                </div>
              </div>
            </div>
            <div class="row">
...
<div class="clearfix"></div>
<section class="exp-n-fres we-are-hiring-cmn">
  <div class="exp">
...
<div class="clearfix"></div>
<section class="refer-a-friend cmn-padd">
  <div class="container">
    <div class="row">
      <h2 class="cmn-hdr">
        <span class="line-img"><img src="images/team-cln.png" alt="team colon icon"></span>
